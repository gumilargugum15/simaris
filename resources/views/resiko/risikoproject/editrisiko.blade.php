...
<h1>
    Data
    <small>Edit risiko project</small>
</h1>
<ol class="breadcrumb">
    <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
    <li class="active">Dashboard</li><li class="active">Edit risiko project</li>
</ol>
</section>
...
<div class="box">
        <div class="box-body">
                <div class="box box-warning">
                        ...
                        @endif
                        <form action="{{ url('updateriskproject') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                            <div class="col-xs-8">
                            <input type="text" class="form-control" name="periode" id="periode" value="{{ $riskproject->periode }}" placeholder="Periode ..." readonly required>
                            </div>
                            <div class="col-xs-4">
                            <input type="text" class="form-control" name="tahun" id="tahun" value="{{ $riskproject->tahun }}" placeholder="Tahun ..." readonly required>
                            </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <select class="form-control select2" style="width: 100%;" name="project" id="project" required>
                                ...
                                @if($riskdetail->project_id==$rowproject->id)
                                <option value="{{$rowproject->id}}" selected>{{$rowproject->nama}}</option>
                                @else
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" style="width: 100%;" name="tahapproject" id="tahapproject" required>
                                ...
                                @if($riskdetail->tahapproject_id==$rowtahapproject->id)
                                <option value="{{$rowtahapproject->id}}" selected>{{$rowtahapproject->nama}}</option>
                                @else
                        ...
                        <input type="text" class="form-control" name="dampak" id="dampak" placeholder="Dampak ..." value="{{$riskdetail->namadampak}}" readonly>
                        </div>
                        <div class="form-group">
                        <label>Warna</label>
