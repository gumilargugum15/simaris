        ...
        <div class="box-body">
                <div class="box box-warning">
                    ...
                    <form action="{{ url('updateproject') }}" method="post" enctype="multipart/form-data">
                        ...
                        <input type="text" class="form-control" name="nama" id="nama" value="{{ $project->nama }}">
                        </div>
                        <div class="form-group">
                        <label>Unit</label>
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" name="keyperson" id="keyperson" placeholder="Input nik keyperson" value="{{ $project->keyperson }}">
                            ...
                            <input type="text" class="form-control" name="namakeyperson" id="namakeyperson" readonly value="{{ $project->namakeyperson }}">
                            </div>
                            <div class="form-group">
                            <label>Jabatan keyperson</label>
                            <input type="text" class="form-control" name="jabkeyperson" id="jabkeyperson" readonly value="{{ $project->jabkeyperson }}">
                            </div>
                            <div class="form-group">
                            <input type="text" class="form-control" name="pm" id="pm" placeholder="Input nik project manager" value="{{ $project->pm }}">
                            <a class="btn btn-primary" onclick="carikeyperson('pm')"><i class="fa fa-search (alias)" title="">&nbsp;Cari</i></a><br><br>
                            </div>
                            <div class="form-group">
                            <label>Nama PM</label>
                            
                            <input type="text" class="form-control" name="namapm" id="namapm" readonly value="{{ $project->namapm }}">
                            </div>
                            <div class="form-group">
                            <label>Jabatan PM</label>
                            <input type="text" class="form-control" name="jabpm" id="jabpm" readonly value="{{ $project->jabpm }}">
                            </div>
                            <div class="form-group">
                            <label>Nama Kontrak</label>
                            <input type="text" class="form-control" name="namakontrak" id="namakontrak" value="{{ $project->namakontrak}}">
                            </div>
                            <div class="form-group">
                            <label>Nomor Kontrak</label>
                            <input type="text" class="form-control" name="nomorkontrak" id="nomorkontrak" value="{{ $project->nomorkontrak }}">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control pull-right" id="startenddate" name="startenddate" value="{{$staredndate}}">
                            </div>
                            <!-- /.input group -->
                        </div>
